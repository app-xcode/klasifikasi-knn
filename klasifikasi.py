...
if st.button("Prediksi Kelas"):
    ...
    f"""<div style='background-color:#d4edda;
                ...
                border-radius:8px;
                font-size:20px;'>
        Nilai akurasi yang terbaik dipilih nilai K {best_overall_k[0]} pada fold {fold_max} dengan akurasi tertinggi {best_overall_acc:.2f}, sehingga hasil prediksi kelas baru adalah : {pred}
    </div>
    """,
    unsafe_allow_html=True
    )
